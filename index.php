...
if(isset($_GET["video"])){
    $sql="select titulo, codigo, CONCAT('"."http://".$_SERVER["SERVER_NAME"].$_SERVER["PHP_SELF"]."?video=',md5(titulo)) as url, url as url2 from mox_chicas where md5(titulo)='".mosgetparam($_GET,"video","")."' and estado=1";
    $db->setQuery($sql);
    $res=$db->loadObjectList();
    if(count($res)==0){
        $sql="select titulo, codigo, CONCAT('"."http://".$_SERVER["SERVER_NAME"].$_SERVER["PHP_SELF"]."?video=',md5(titulo)) as url, url as url2 from mox_chicas where destacado=1 and estado=1";
        $db->setQuery($sql);
        $res=$db->loadObjectList();
    }
}
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div id="pagina">
            ...
            <div id="inicol1">
                <div id="hlcientochicas"><script type="text/javascript">runSWF2("flash/hl-ciento-de-chicas.swf", 235, 142,"8,0,29,0", "transparent");</script></div>
                ...
                <div id="hlqueesmoxie"><script type="text/javascript">runSWF2("flash/hl-que-es-moxie2.swf", 235, 104,"8,0,29,0", "transparent");</script></div>
                <div id="hlsiguenosen" style="height:108px">
                    <a id="siguenos_facebook" target="_blank" href="http://www.facebook.com/pages/Chica-Moxie/133609124230"></a>
                    <a id="siguenos_tuenti" target="_blank" href="http://www.tuenti.com/#m=Profile&func=index&user_id=66061526"></a>
                    <a id="siguenos_twitter" target="_blank" href="http://twitter.com/chicamoxie"></a>
                </div>
            </div>
            ...
            <div id="videoprincipal1">
                ...
                <div id="panelcompartir">
                    <a id="comtwitter" target="_blank" href="http://twitter.com/home?status=<?php echo rawurlencode("Echa un vistazo a &eacute;ste video de una Chica Moxie: ").$destacado->url2 ?>"></a>
                ...
                <div style="height:70px;" id="flparticipa">
                    ...
                    <a id="btnparticipa" onclick="cargaparticipa()">&nbsp;</a>
                </div>
            </div>
            <div id="inicol2">
                <div style="height:211px; margin-top:-10px; position:relative; z-index:5;">
                    <div id="flashconcurso"><script type="text/javascript">runSWF2("flash/hl-noticias-descargas.swf", 205, 211,"8,0,29,0", "transparent");</script></div>
                    <div id="maskconcurso" onclick="cargaconcurso()" ></div>
                </div>
        ...
        <div class="jqmWindow" id="dlgconcurso">
            <a class="btncerrar" onclick="$('#dlgconcurso').jqmHide()" >&nbsp;</a>
            <div id="conconcurso">
                <div id="contitulo"></div>
                <div id="concol1">
                    <div id="conimg1" class="conimg"></div>
                    <div id="conimg2" class="conimg"></div>
                    <div id="conimg3" class="conimg"></div>
                    <div id="conimg4" class="conimg"></div>
                </div>
                <div id="concol2">
                    <div id="contxt"></div>
                    <a id="contwitter" target="_blank" href="http://twitter.com/chicamoxie"></a>
                    <a id="conbases" target="_blank" href="descargas/BASES_PROM_MOXIE_TWITTER.pdf"></a>
                </div>
