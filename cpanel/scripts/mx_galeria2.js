...
var cad=$(campo+'_cont').innerHTML+'<div class="galeria2_img" id="'+campo+'_img_'+ a +'">';

if(a>0) { cad=cad+ '<div style="float:left;margin-top:30px;width:10px"><a href="javascript:posicion_galeria(\''+campo+'\',-1,'+a+')" class="galeria_btnimg" ><img src="images/mizq.png"  border="0" width="10" height="20" /></a></div>'; }
else  { cad=cad+ '<div style="float:left;margin-top:30px;width:10px"></div>'; }

cad=cad+'<div style="width:80px; float:left"><a href="images/galeria_'+campo+'/' + imagen + '" rel="lightbox"><img src="images/galeria_'+campo+'/th_'+imagen+'" border="0" width="80" height="80" /></a><br /><div align="center"><a href="javascript:eliminar_galeria(\''+campo+'\','+a+','+ long +')" class="galeria_txt"><img src="images/ico_x.png"  border="0" style="margin-top:4px" />&nbsp;'+ imagentxt+'</a></div></div>';

if(a<total) { cad=cad+'<div style="float:left;margin-top:30px;width:10px"><a href="javascript:posicion_galeria(\''+campo+'\',1,'+a+')" class="galeria_btnimg" ><img src="images/mder.png"  border="0" width="10" height="20" /></a></div>'; }
else { cad=cad+'<div style="float:left;margin-top:30px;width:10px"></div>'; }
