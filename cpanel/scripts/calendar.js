  ...
  if (document.all) { fc_ie = true; }
	...
	var calendars = Array();
	var fc_months = Array('Ene', 'Feb', 'Mar', 'Abr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dic');
	var fc_openCal;
	...
	function fc_show() {
		...
		if (typeof(this.div) == 'undefined') {
			...
			ptop=fc_absoluteOffsetTop(this.element) + this.element.offsetHeight + 1;
			this.div.style.top = ptop+"px";
