...
var scwLanguage;
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #FF7C21;}'  +
            '/* Drag Handle */'                                         +
            ...
            'td.scwCellsExMonth         {background-color:  #CCCCCC;'   +
                                        'color:             #666666;}'  +
            '/* Today selector */'                                      +
            'td.scwNow                  {background-color:  #FFFFFF;'   +
                                        'color:             #0D1F8B;'  +
										'font-size:     8pt;} '+
            '/* Clear Button */'                                        +
            ...
            '/* Active cells */'                                        +
            'td.scwCells:hover,'                                        +
            'td.scwCellsHover           {background-color:  #0D1F8B;'   +
                                        'cursor:            pointer;'   +
                                        'color:             #FFFFFF;}'  +
            '/* Day matching the input date */'                         +
            'td.scwInputDate:hover,'                                    +
            ...
            '/* Weekend cells */'                                       +
            'td.scwCellsWeekend:hover,'                                 +
            'td.scwCellsWeekendHover    {background-color:  #FF7C21;'   +
                                        'cursor:            pointer;'   +
                                        'color:             #000000;}'  +
            '/* Day outside the current month */'                       +
            'td.scwCellsExMonth:hover,'                                 +
